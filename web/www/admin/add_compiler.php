<?php
  ...
  if($_SESSION['priority']=='admin')
  {
  	if(isset($_POST['submit']))
  	{
  		...
  		{
  			$ADMIN->add_compiler($_POST['extensions'],$_POST['compilerpath'],$_POST['params']);
  			$status = "Компілятор додано";
  		}else $status = "Не заповнені необхідні поля";
  	}
...
<head>
<title>Sandra - Додати компілятор</title>
  ...
  <div id="inner_middle">
    ...
    <div style='margin-left:30px;margin-top:20px;'>
     ...
     <form name='compilerForm' action = '' method = 'post' onsubmit='return checkCompilerForm();'>
       ...
       <input type = 'text' name = 'extensions'><br>
        Повний шлях до файлу компілятора<br>
       <input type = 'text' name = 'compilerpath'><br>
